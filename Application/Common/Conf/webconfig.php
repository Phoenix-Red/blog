...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '待定，还没发布上线',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  'lxb1322046631@163.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  'Phoenix_Red\'s Blog',             //网站名：
    'WEB_KEYWORDS'              =>  '技术博客,个人博客',         //网站关键字
    'WEB_DESCRIPTION'           =>  'Phoenix_Red的个人技术博客',      //网站描述
    'AUTHOR'                    =>  'Phoenix_Red',               //默认作者
    'COPYRIGHT_WORD'            =>  'Phoenix_Red\'s Blog版权所有,转载注明出处',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  'Phoenix_Red\'s Blog', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'lxb1322046331@163.com',      //文字水印内容
...
//***********************************邮箱设置***********************************************
    ...
    'EMAIL_USERNAME'            =>  'lxb1322046331@163.com',       //  邮箱用户名
    'EMAIL_PASSWORD'            =>  'lxb1322046331',       //  邮箱密码
    'EMAIL_FROM_NAME'           =>  'Phoenix_Red\'s Blog',      //  发件名
//***********************************评论管理***********************************************
    'COMMENT_REVIEW'            =>  '1',       // 评论审核1:开启 0:关闭
    'COMMENT_SEND_EMAIL'        =>  '1',   // 被评论邮件通知1:开启 0:关闭
    'EMAIL_RECEIVE'             =>  'lxb1322046331@163.com',        // 接收评论通知邮箱
